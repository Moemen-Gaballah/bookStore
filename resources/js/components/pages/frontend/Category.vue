            ...
            <div class="books">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                        <div class="card">
                            <a href="/book" target="_blank">
                              <img src="img/book/01.png" class="card-img-top" alt="...">
                              <div class="card-body">
                                    <h5 class="card-title">
                                        يرى من خلال الوجوه
                                    </h5>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                        <div class="card">
                            <a href="/book" target="_blank">
                               <img src="img/book/2.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                                    <h5 class="card-title">
                                        فيليكس والنبع الامرئى
                                    </h5>
                                    <p class="card-text">
                                        افنان العتيبى
                                    </p>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                        <div class="card">
                            <a href="/book" target="_blank">
                              <img src="img/book/4.jpg" class="card-img-top" alt="...">
                              <div class="card-body">
                                    <h5 class="card-title">
                                        رايت الرعب فرانى
                                    </h5>
                                    <p class="card-text">
                                        فيصل بن عبدالعزيز الحمودى
                                    </p>
                                </div>
                            </a>
                            <p class="price">
