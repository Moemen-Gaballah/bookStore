...
<div class="sliderProducts">
    <div class="container">
        <!-- <div v-for="category in allCategories" class="bbb_viewed"> -->
                ...
                <div class="col">
                    <div class="bbb_main_container">
                        <div class="bbb_viewed_title_container">
                            ...
                            </div> <!-- End div bbb_viewed_nav_container -->
                        </div> <!-- End div bbb_viewed_title_container -->
                        <div class="bbb_viewed_slider_container">
                            ...
                            </div> <!-- End div bbb_viewed_slider -->
                        </div> <!-- End div bbb_viewed_slider_container -->
                    </div> <!-- End div bbb_main_container -->
                </div> <!-- End div col -->
            </div> <!-- End div row -->
        </div> <!-- End div bbb_viewed -->
